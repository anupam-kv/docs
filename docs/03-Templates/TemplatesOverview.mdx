...
<CardGroup cols={3}>
  <Card title="SMS" icon="Message" href="/docs/03-Templates/Template%20Configurations/SMS-Template">
    
  </Card>
  <Card title="Email" icon="google" href="/docs/03-Templates/Template%20Configurations/Email-Template">
    
  </Card>
  <Card title="Push Notification" icon="message" href="/docs/03-Templates/Template%20Configurations/Push-Template">
    
  </Card>
  <Card title="Whatsapp" icon="Whatsapp" href="/docs/03-Templates/Template%20Configurations/Whatsapp-Template">
    
  </Card>
  <Card title="Slack" icon="slack" href="/docs/03-Templates/Template%20Configurations/Slack-Template">
    
  </Card>
  <Card title="Microsoft Teams" icon="Microsoft " href="/docs/03-Templates/Template%20Configurations/Teams-Template">
    
  </Card>
  <Card title="Discord" icon="discord" href="/docs/03-Templates/Template%20Configurations/Discord-Template">
    
  </Card>
  <Card title="In-App Messages" icon="Siren" href="/docs/03-Templates/Template%20Configurations/InApp-Template">
    
  </Card>
  <Card title="LINE" icon="Line" href="/docs/03-Templates/Template%20Configurations/LINE-Template">
