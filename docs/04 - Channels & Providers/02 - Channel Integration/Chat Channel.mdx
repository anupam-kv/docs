...
>**_Note:_** To track the responses & interactions of user in Slack, you have to copy the URL in   **Inbound Webhook Path** field from the **Add Account** pop-up window, and paste it in the **Request URL** section in the [Slack App Configuration](../../../06%20-%20Configurations/Slack-app-configuration.md).
---
