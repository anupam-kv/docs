...
- <u>can add quick send, logs, fallbacks, etc</u>
...
With basics covered. let's move on to configuring Siren so you can start delivering your first notifications.