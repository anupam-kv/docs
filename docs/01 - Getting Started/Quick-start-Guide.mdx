...
<Steps>
  <Step title="Create Your Siren Account">
    Sign up at [Siren](https://app.trysiren.io/) using **Gmail** or **GitHub**. ~~(add manual option as well?)~~
  </Step>
  <Step title="Generate Your API Key">
    ~~(user can get key at onboarding as well. should we mention?)~~
  ...
  <Step title="Set Up Your Providers">
    <Info>
      A default provider named **Sample Email Provider** is already configured under the Email channel. ~~(lets give it below)~~
    </Info>
  ...
  <Step title="Send Your First Message">
    ...
    [Go to MCP](/docs/MCP) to see the integration guide

    #### • AI Agent Toolkit

    ~~After integrating the AI agent toolkit, you can go to your LLM or Conversational AI and give a prompt to send a message with the details~~. \
    [Go to Toolkit Setup](/docs/MCP) to see the integration guide
    ...
    [Go to SDK Docs](https://docs.trysiren.io/docs/SDK) to see the integration guide
