...
Integrate your AI agent to automatically configure workflows, templates, and notification logic based on your internal context.\
...
Use Siren’s flexible, lightweight APIs to send messages without creating a full workflow. You can trigger one-off notifications, run campaigns, or call workflows.\
→ [Explore API Reference](https://docs.trysiren.io/docs/API%20Reference)

> **Tip:** Use **QuickSend** to send and track messages instantly via API without any setup.
