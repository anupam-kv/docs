...
Use Siren’s flexible, lightweight APIs to send messages without creating a full workflow. You can trigger one-off notifications, run campaigns, or call workflows. Go to [QuickSend ](/docs/01 - Getting Started/QuickSend)to see how to send message using APIs
