...
Version history and the changes in the workflow can be easily monitored and tracked by clicking on the "🕘" icon on the right top panel.

- The contributor of each changes and the time and date of these changes can be viewed here.
![version-control](../Images/Workflow/WorkflowVersionHistory.png)