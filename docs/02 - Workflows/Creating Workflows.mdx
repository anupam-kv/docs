...
>**_Note:_** When to Use Basic vs Advanced Workflows
...
- Add your desired [nodes](Design%20Workflow%20Logic). The input JSON will be automatically updated with the corresponding structure.
...
- [Test your Workflow](Test%20&%20Trigger) before publishing.